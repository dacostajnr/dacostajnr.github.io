...
__export(src_exports, {
  ...
  MovablePointDisplay: () => MovablePointDisplay,
  Plot: () => Plot,
  Point: () => Point,
  Polygon: () => Polygon,
  Polyline: () => Polyline,
...
function OfY({ x, ...props }) {
  ...
  const xy = React11.useCallback((y) => [x(y), y], [x]);
  const t = React11.useMemo(() => [yMin, yMax], [yMin, yMax]);
  return /* @__PURE__ */ (0, import_jsx_runtime8.jsx)(Parametric, { xy, t, ...props });
}
...
function VectorField({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(import_jsx_runtime9.Fragment, { children: layers.map((layer, index) => /* @__PURE__ */ (0, import_jsx_runtime9.jsx)(
    "path",
    {
      d: layer.d,
      style: {
...
function Inequality({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime10.jsxs)("g", { children: [
    ...
    upperBoundType != 0 /* UNBOUNDED */ && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "path",
      {
        d: svgPath.upper,
    ...
    lowerBoundType != 0 /* UNBOUNDED */ && /* @__PURE__ */ (0, import_jsx_runtime10.jsx)(
      "path",
      {
        d: svgPath.lower,
...
function PointAngle({ point, angle, ...rest }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime12.jsx)(ThroughPoints, { point1: point, point2, ...rest });
}
...
function PointSlope({ point, slope, ...rest }) {
  return /* @__PURE__ */ (0, import_jsx_runtime13.jsx)(PointAngle, { point, angle: Math.atan(slope), ...rest });
}
...
function Circle({ radius, ...rest }) {
  return /* @__PURE__ */ (0, import_jsx_runtime16.jsx)(Ellipse, { radius: [radius, radius], ...rest });
}
...
function Polygon({ svgPolygonProps, ...otherProps }) {
  return /* @__PURE__ */ (0, import_jsx_runtime18.jsx)(PolyBase, { element: "polygon", svgPolyProps: svgPolygonProps, ...otherProps });
}
...
function Vector({
  ...
  const id = React12.useMemo(() => `mafs-triangle-${incrementer2++}`, []);
  return /* @__PURE__ */ (0, import_jsx_runtime21.jsxs)(import_jsx_runtime21.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("defs", { children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("marker", { id, markerWidth: "8", markerHeight: "8", refX: "8", refY: "4", orient: "auto", children: /* @__PURE__ */ (0, import_jsx_runtime21.jsx)("path", { d: "M 0 0 L 8 4 L 0 8 z", fill: color || "var(--mafs-fg)", strokeWidth: 0 }) }) }),
...
// src/interaction/useMovable.tsx
...
function useMovable(args) {
  ...
  const inverseTransform = React13.useMemo(() => getInverseTransform(userTransform), [userTransform]);
  const pickup = React13.useRef([0, 0]);
...
var MovablePointDisplay = React14.forwardRef(
  (props, ref) => {
    const { color = Theme.pink, ringRadiusPx = 15, dragging, point } = props;
    const { viewTransform, userTransform } = useTransformContext();
    const combinedTransform = React14.useMemo(
    ...
    return /* @__PURE__ */ (0, import_jsx_runtime23.jsxs)(
      "g",
      {
        ...
        tabIndex: 0,
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("circle", { className: "mafs-movable-point-hitbox", r: 30, cx: xPx, cy: yPx }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("circle", { className: "mafs-movable-point-ring", r: ringRadiusPx, cx: xPx, cy: yPx }),
          /* @__PURE__ */ (0, import_jsx_runtime23.jsx)("circle", { className: "mafs-movable-point-point", r: 6, cx: xPx, cy: yPx })
        ]
      }
    );
  }
...
function MovablePoint({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime24.jsx)(MovablePointDisplay, { ref, point, color, dragging });
}
...
function useMovablePoint(initialPoint, { constrain, color = Theme.pink } = {}) {
  ...
  const [point, setPoint] = React16.useState(initialPoint);
  const [x, y] = point;
  const constraintFunction = React16.useMemo(() => {
  ...
  const element = React16.useMemo(() => {
    return /* @__PURE__ */ (0, import_jsx_runtime25.jsx)(MovablePoint, { ...{ point, color }, constrain: constraintFunction, onMove: setPoint });
...
function useStopwatch(options) {
  ...
  const startClockTime = React17.useRef(null);
  const [time, setTime] = React17.useState(startTime);
  ...
  const start = React17.useCallback(() => setPlaying(true), []);
  const stop = React17.useCallback(() => {
    startClockTime.current = null;
    setPlaying(false);
    setTime(startTime);
  }, [startTime]);
...
function Transform(props) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime26.jsx)(TransformContext.Provider, { value: { userTransform: newUserTransform, viewTransform }, children: /* @__PURE__ */ (0, import_jsx_runtime26.jsx)("g", { style: { "--mafs-user-transform": vec.toCSS(newUserTransform) }, children }) });
}
...
function ViewportInfo({ precision = 3 }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("g", { className: "mafs-shadow", fontFamily: "monospace", children: [
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("text", { x: x + 10, y: y - 70, children: [
      "x: (",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("text", { x: x + 10, y: y - 50, children: [
      "y: (",
    ...
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("text", { x: x + 10, y: y - 30, children: [
      "xPanes: ",
      xPanesString
    ] }),
    /* @__PURE__ */ (0, import_jsx_runtime27.jsxs)("text", { x: x + 10, y: y - 10, children: [
      "yPanes: ",
      yPanesString
    ] })
  ] });
...
function TransformWidget({ children }) {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(import_jsx_runtime28.Fragment, { children: [
    /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(Transform, { translate: t.point, children: [
      /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(Transform, { rotate: angle, children: [
        /* @__PURE__ */ (0, import_jsx_runtime28.jsxs)(Transform, { scale: s.point, children: [
          children,
    ...
    "foreignObject",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)(
        "div",
        {
          ...
          children: /* @__PURE__ */ (0, import_jsx_runtime29.jsx)("span", { ref })
        }
      )
    }
  );
