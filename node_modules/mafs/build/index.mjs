...
function OfY({ x, ...props }) {
  ...
  return /* @__PURE__ */ jsx8(Parametric, { xy, t, ...props });
}
...
function VectorField({
  ...
  return /* @__PURE__ */ jsx9(Fragment3, { children: layers.map((layer, index) => /* @__PURE__ */ jsx9(
    "path",
    {
      d: layer.d,
      style: {
...
function Inequality({
  ...
  return /* @__PURE__ */ jsxs4("g", { children: [
    ...
    upperBoundType != 0 /* UNBOUNDED */ && /* @__PURE__ */ jsx10(
      "path",
      {
        d: svgPath.upper,
    ...
    lowerBoundType != 0 /* UNBOUNDED */ && /* @__PURE__ */ jsx10(
      "path",
      {
        d: svgPath.lower,
...
function PointAngle({ point, angle, ...rest }) {
  ...
  return /* @__PURE__ */ jsx12(ThroughPoints, { point1: point, point2, ...rest });
}
...
function PointSlope({ point, slope, ...rest }) {
  return /* @__PURE__ */ jsx13(PointAngle, { point, angle: Math.atan(slope), ...rest });
}
...
function Circle({ radius, ...rest }) {
  return /* @__PURE__ */ jsx16(Ellipse, { radius: [radius, radius], ...rest });
}
...
function Polygon({ svgPolygonProps, ...otherProps }) {
  return /* @__PURE__ */ jsx18(PolyBase, { element: "polygon", svgPolyProps: svgPolygonProps, ...otherProps });
}
...
import { Fragment as Fragment4, jsx as jsx21, jsxs as jsxs5 } from "react/jsx-runtime";
var incrementer2 = 0;
function Vector({
  tail = [0, 0],
  tip,
  ...
  return /* @__PURE__ */ jsxs5(Fragment4, { children: [
    /* @__PURE__ */ jsx21("defs", { children: /* @__PURE__ */ jsx21("marker", { id, markerWidth: "8", markerHeight: "8", refX: "8", refY: "4", orient: "auto", children: /* @__PURE__ */ jsx21("path", { d: "M 0 0 L 8 4 L 0 8 z", fill: color || "var(--mafs-fg)", strokeWidth: 0 }) }) }),
    /* @__PURE__ */ jsx21(
      "line",
      {
        x1: pixelTail[0],
  ...
  (props, ref) => {
    ...
    return /* @__PURE__ */ jsxs6(
      "g",
      {
        ...
        tabIndex: 0,
        children: [
          /* @__PURE__ */ jsx23("circle", { className: "mafs-movable-point-hitbox", r: 30, cx: xPx, cy: yPx }),
          /* @__PURE__ */ jsx23(
            "circle",
            {
          ...
          /* @__PURE__ */ jsx23("circle", { className: "mafs-movable-point-ring", r: ringRadiusPx, cx: xPx, cy: yPx }),
          /* @__PURE__ */ jsx23("circle", { className: "mafs-movable-point-point", r: 6, cx: xPx, cy: yPx })
        ]
      }
    );
  }
...
function MovablePoint({
  ...
  return /* @__PURE__ */ jsx24(MovablePointDisplay, { ref, point, color, dragging });
}
...
function useMovablePoint(initialPoint, { constrain, color = Theme.pink } = {}) {
  ...
  const element = React16.useMemo(() => {
    return /* @__PURE__ */ jsx25(MovablePoint, { ...{ point, color }, constrain: constraintFunction, onMove: setPoint });
...
function Transform(props) {
  ...
  return /* @__PURE__ */ jsx26(TransformContext.Provider, { value: { userTransform: newUserTransform, viewTransform }, children: /* @__PURE__ */ jsx26("g", { style: { "--mafs-user-transform": vec.toCSS(newUserTransform) }, children }) });
}
...
import { Fragment as Fragment5, jsx as jsx27, jsxs as jsxs8 } from "react/jsx-runtime";
    ...
    "foreignObject",
    {
      ...
      children: /* @__PURE__ */ jsx28(
        "div",
        {
          ...
          children: /* @__PURE__ */ jsx28("span", { ref })
        }
      )
    }
  );
